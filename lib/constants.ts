...
export const CASES = [
  ...
  },
  {
    ...
    title: "Acal",
    excerpt:
      "Alavancando vendas e conversões com campanhas otimizadas de mídia paga.",
    metric: "45%",
...
export const CASE_DETAILS: Record<CaseSlug, CaseDetail> = {
    ...
    strategy: [
      {
        ...
        description:
          "Mapeamos todo o funil comercial da Sou Energy,  do primeiro clique ao fechamento,  identificando os pontos de ruptura entre marketing e vendas. Esse diagnóstico foi o alicerce de toda a estratégia.",
      },
      {
        title: "Estrutura de campanhas por etapa do funil",
        description:
          "Criamos campanhas distintas para topo, meio e fundo de funil no Google Ads e Meta Ads, com criativos, públicos e ofertas específicos para cada momento da jornada de compra do cliente B2B.",
      },
      {
        title: "Rastreamento avançado e CRM integrado",
        description:
          "Implementamos UTMs, eventos de conversão personalizados e integração com CRM para rastrear cada touchpoint,  do anúncio ao contrato. Pela primeira vez, a empresa sabia exatamente de onde vinha cada cliente.",
      },
      {
        title: "Fluxo de nutrição para leads qualificados",
        description:
          "Criamos um fluxo automatizado de nutrição para leads em estágio médio de funil, reduzindo o tempo de resposta do time comercial e aumentando a taxa de conversão de lead para proposta.",
      },
      {
        title: "Otimização contínua orientada por dados",
        description:
          "Com o tracking funcionando, passamos a otimizar com precisão: testes A/B de criativos, ajuste de lances por segmento, exclusão de públicos não qualificados. Cada semana melhor que a anterior.",
      },
    ],
    results: [
      {
      ...
      {
        metric: "3,2x",
        label: "redução no custo por lead qualificado",
        context:
          "Com segmentação precisa e nutrição estruturada, o custo de aquisição caiu drasticamente.",
      },
      {
        metric: "100%",
        label: "visibilidade do funil comercial",
        context:
          "Pela primeira vez, marketing e vendas operavam com os mesmos dados em tempo real.",
      },
    ],
    conclusion:
    ...
    strategy: [
      {
        ...
        description:
          "Estruturamos campanhas individuais por unidade no Meta Ads, Google Ads e YouTube, com segmentação geográfica precisa, públicos locais e criativos adaptados à realidade de cada cidade,  sem abrir mão da escala.",
      },
      {
        title: "Landing pages otimizadas por serviço e localidade",
        description:
          "Criamos páginas de destino específicas por serviço e cidade, com testes contínuos de oferta, CTA e formulário. Taxa de conversão otimizada unidade por unidade, não em média geral.",
      },
      {
        title: "Modelo de Performance Multi-Funil",
        description:
          "Implementamos campanhas de topo de funil para construção de audiência qualificada e remarketing escalonado,  do primeiro impacto ao agendamento, cada etapa com mensagem e oferta específicas.",
      },
      {
        title: "Sistema de ativação imediata de leads",
        description:
          "Integramos formulários ao CRM e WhatsApp Business de cada unidade. Quando um lead chegava, o atendimento era acionado em minutos,  não em dias. Velocidade de resposta como vantagem competitiva.",
      },
      {
        title: "Dashboard de performance por unidade",
        description:
          "Relatórios semanais individualizados com CPL, volume de agendamentos e faturamento estimado por canal para cada unidade. Gestão baseada em dados, não em achismo.",
      },
    ],
    results: [
      {
      ...
      {
        metric: "20+",
        label: "unidades com campanhas simultâneas",
        context:
          "Arquitetura que permite gestão centralizada com resultados locais,  sem perda de eficiência.",
      },
      {
        metric: "4,8x",
        label: "aumento no volume de agendamentos/mês",
        context:
          "Mais leads qualificados chegando mais rápido ao atendimento,  agendas sempre ocupadas.",
      },
    ],
    conclusion:
  ...
  kamibaa: {
    ...
    eyebrow: "Case de Sucesso",
    headline:
      "Mais de 3,4% de engajamento: como a Kamibaa construiu uma marca forte no digital em 6 meses",
    ...
    quote:
      "Brand building no digital não é sobre viralizar uma vez. É sobre aparecer todo dia, do jeito certo, para as pessoas certas,  até que a sua marca seja a primeira que elas lembram quando bate a fome.",
    challenge:
    ...
    strategy: [
      {
        ...
        description:
          "Estruturamos um calendário de conteúdo pago mensal com foco nas histórias que fazem a Kamibaa única: a culinária oriental, os ingredientes, os bastidores e as sazonalidades que criam momentos de consumo.",
      },
      {
        title: "Linha criativa visual consistente",
        description:
          "Desenvolvemos uma identidade criativa para as campanhas,  warm, autêntica e apetitosa,  que traduzia a alma da marca em cada formato: Reels, carrosséis, stories e banners.",
      },
      {
        title: "Distribuição estratégica de verba por objetivo",
        description:
          "Dividimos o orçamento entre campanhas de alcance (para novos públicos), engajamento (para construir comunidade) e conversão (para gerar pedidos),  cada uma com lógica, métrica e otimização próprias.",
      },
      {
        title: "Testes de formato e horário por ciclo semanal",
        description:
          "Toda semana analisamos qual formato estava gerando mais engajamento orgânico pós-impulsionamento, em quais horários e para quais segmentos. Os insights de um mês alimentavam a estratégia do próximo.",
      },
      {
        title: "Controle de frequência e renovação criativa",
        description:
          "Monitoramos ativamente a fadiga de anúncio,  trocando criativos antes que o engajamento caísse. Esse ciclo contínuo de renovação manteve a performance estável por 6 meses consecutivos.",
      },
    ],
    results: [
      {
        metric: ">3,4%",
        label: "taxa de engajamento nas campanhas",
        context:
          "Mais que o dobro da média do setor de alimentação,  público real reagindo ao conteúdo, não só visualizando.",
      },
      {
        metric: "6 meses",
        label: "de performance consistente sem queda",
        context:
          "Sem picos e vales,  crescimento estável construindo marca mês a mês.",
      },
      {
        metric: "2,1x",
        label: "crescimento no alcance mensal",
        context:
          "Mais pessoas conhecendo a Kamibaa todo mês, com custo por resultado decrescente.",
      },
    ],
    conclusion:
  ...
  camed: {
    ...
    eyebrow: "Case de Sucesso",
    headline:
      "48% mais leads: como a Camed entrou no digital do jeito certo e transformou tradição em performance",
    ...
    quote:
      "Quando você tem 40 anos de reputação, o digital não precisa ser um salto no escuro. Precisa ser uma extensão inteligente do que já funciona,  com a estrutura certa para medir cada resultado.",
    challenge:
    ...
    strategy: [
      {
        ...
        description:
          "Antes de investir um centavo em mídia, mapeamos quem é o cliente ideal da Camed no ambiente digital,  interesses, comportamentos, palavras-chave que usam, e o momento da jornada em que estão mais propensos a converter.",
      },
      {
        title: "Campanhas de intenção no Google Ads",
        description:
          "Criamos campanhas na rede de pesquisa focadas em palavras-chave de alta intenção,  quem busca ativamente por seguro está mais próximo da decisão. Display estratégico para geração de consciência de marca.",
      },
      {
        title: "Landing pages por produto e perfil",
        description:
          "Desenvolvemos páginas de destino específicas por linha de produto, com proposta de valor clara, formulários simplificados e CTAs alinhados à linguagem do mercado de seguros,  confiança antes de tudo.",
      },
      {
        title: "Processo de qualificação e ativação comercial",
        description:
          "Integramos os leads digitais ao processo comercial da Camed, criando um fluxo de qualificação antes do contato,  para que o time recebesse apenas leads com perfil real de compra, dentro de 24 horas.",
      },
      {
        title: "Relatórios e otimização mensal com foco em CAC",
        description:
          "Acompanhamos mensalmente o custo de aquisição por produto, ajustando lances e criativos conforme os dados. Cada otimização era guiada pela pergunta: quanto está custando cada cliente fechado?",
      },
    ],
    results: [
      {
        ...
        context:
          "Em poucos meses, o canal digital tornou-se uma fonte consistente e mensurável de novos clientes.",
      },
      {
        metric: "Do zero",
        label: "à estrutura completa de performance",
        context:
          "Toda a infraestrutura de mídia paga montada do zero,  tracking, páginas, campanhas e processos.",
      },
      {
        metric: "24h",
        label: "tempo máximo de ativação de leads",
        context:
          "Leads qualificados chegando ao time comercial em menos de 24 horas, no momento certo da decisão.",
      },
    ],
    conclusion:
  ...
  "diamantes-lingerie": {
    ...
    eyebrow: "Case de Sucesso",
    headline:
      "45% de crescimento em conversões: como a Diamantes Lingerie escalou vendas sem escalar custo",
    ...
    quote:
      "No varejo digital, quem converte mais não é necessariamente quem gasta mais,  é quem tem o sistema de remarketing certo, o criativo certo e a segmentação certa. Os três juntos fazem toda a diferença.",
    challenge:
    ...
    strategy: [
      {
        ...
        description:
          "Reconstruímos as campanhas com segmentação por interesse específico, comportamento de compra e públicos lookalike baseados nos melhores compradores,  eliminando desperdício e aumentando a qualidade do alcance.",
      },
      {
        title: "Funil de remarketing em 3 etapas",
        description:
          "Criamos um fluxo de remarketing estruturado: visitantes de página de produto, usuários que adicionaram ao carrinho e abandonadores de checkout,  cada grupo com mensagem, urgência e oferta específicas para o seu momento.",
      },
      {
        title: "Testes de criativo com UGC e formatos variados",
        description:
          "Implementamos ciclos de teste com conteúdo gerado por usuárias reais (UGC), fotos de produto profissionais e Reels curtos. O criativo que mais convertia em cada segmento escalava,  os demais saíam do ar.",
      },
      {
        title: "Catálogo dinâmico para personalização em escala",
        description:
          "Ativamos o catálogo dinâmico de produtos integrado às campanhas de shopping e remarketing, entregando para cada usuária exatamente o produto que ela havia visitado,  personalização automática em escala.",
      },
      {
        title: "Controle de ROAS com regras automáticas",
        description:
          "Configuramos regras de otimização automática que pausavam anúncios abaixo do ROAS mínimo e escalavam verba nos que performavam acima da meta,  tornando o processo de escala seguro e orientado por dados.",
      },
    ],
    results: [
      {
        metric: "45%",
        label: "crescimento em conversões",
        context:
          "Mais vendas com o mesmo patamar de investimento,  eficiência real, não apenas mais tráfego.",
      },
      {
        metric: "3x",
        label: "eficiência no remarketing de carrinho",
        context:
          "Abandonadores de carrinho sendo reconquistados com mensagem certa na hora certa.",
      },
      {
        metric: "ROAS meta",
        label: "atingido em todos os meses",
        context:
          "Escalabilidade com previsibilidade,  nunca mais decisão de verba baseada em intuição.",
      },
    ],
    conclusion:
  ...
  acal: {
    ...
    eyebrow: "Case de Sucesso",
    headline:
      "45% de aumento em ROI: como a Acal parou de gastar no escuro e passou a crescer com previsibilidade",
    ...
    quote:
      "O maior problema da maioria das empresas em mídia paga não é gastar pouco,  é gastar sem saber o que funciona. Quando você tem o dado certo, a decisão certa fica óbvia.",
    challenge:
    ...
    strategy: [
      {
        ...
        description:
          "Analisamos cada campanha ativa: públicos, criativos, estrutura de grupos de anúncio e configurações de lance. Identificamos sobreposições, ineficiências e oportunidades de corte imediato,  liberando verba para o que funcionava.",
      },
      {
        title: "Reestruturação por produto, margem e funil",
        description:
          "Reconstruímos a estrutura de campanhas segmentando por produto (e margem de cada um), estágio do funil e intenção de compra. Cada grupo passou a ter objetivo, público e criativo alinhados,  zero desperdício estrutural.",
      },
      {
        title: "Tracking avançado online e offline",
        description:
          "Implementamos rastreamento de conversões offline (visitas à loja, ligações, vendas presenciais atribuídas ao digital) além das conversões online,  para que o ROI real fosse visível, não só o digital isolado.",
      },
      {
        title: "Ciclos semanais de análise e otimização",
        description:
          "Estabelecemos um ritmo de otimização: toda semana, análise de performance por campanha, ajuste de lances, troca de criativos com baixo CTR e escala dos que performavam acima da meta.",
      },
      {
        title: "Dashboard de performance em tempo real",
        description:
          "Criamos um painel centralizado com ROI, CPA, faturamento por canal e comparativo de período,  para que a gestão tivesse visibilidade completa do retorno e pudesse tomar decisões de verba com confiança.",
      },
    ],
    results: [
      {
        metric: "45%",
        label: "aumento em ROI",
        context:
          "Mesmo volume de investimento gerando significativamente mais retorno,  com a estrutura e otimização corretas.",
      },
      {
        metric: "2,7x",
        label: "melhora na eficiência de verba",
        context:
          "Cada real investido passou a trabalhar muito mais,  eliminando desperdício e alocando onde converte.",
      },
      {
        metric: "100%",
        label: "visibilidade do retorno por canal",
        context:
          "Pela primeira vez, decisões de verba baseadas em dados reais,  não em achismo.",
      },
    ],
    conclusion:
...
export const SOCIAL_LINKS = [
  {
    href: "https://www.facebook.com/numerattibr",
    label: "Facebook",
    icon: "facebook" as const,
  },
  {
    href: "https://www.instagram.com/numerattibr/",
    label: "Instagram",
    icon: "instagram" as const,
  },
  {
    href: "https://www.linkedin.com/company/numeratti/about/",
    label: "LinkedIn",
...
export const WHATSAPP_SUPPORT_URL =
  "https://api.whatsapp.com/send?phone=5585988776405";
