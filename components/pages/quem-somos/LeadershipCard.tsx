...
export default function LeadershipCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-stone-200/90 dark:border-stone-800/90 bg-white dark:bg-neutral-950 shadow-[0_12px_40px_-24px_rgba(0,0,0,0.08)] ring-1 ring-stone-100/80">
      <div
      ...
      <div className="relative p-6 sm:p-7">
        <div className="flex flex-wrap items-end justify-between gap-3 border-b border-stone-100 dark:border-stone-800 pb-4">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-stone-500">Liderança</p>
            <h3 className="mt-1 text-lg font-bold tracking-tight text-stone-900 dark:text-stone-100 sm:text-xl">Consultoria Numeratti</h3>
          </div>
        ...
        <div className="mt-5 grid gap-6 sm:grid-cols-[minmax(0,13.75rem)_1fr] sm:items-start sm:gap-8">
          <div className="mx-auto w-full max-w-[220px] sm:mx-0 sm:max-w-none">
            ...
            <div className="relative aspect-[2.2/1] w-full overflow-hidden rounded-md border border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-neutral-950 shadow-inner">
              <Image
          ...
          <div className="min-w-0 sm:border-l sm:border-stone-100 dark:border-stone-800 sm:pl-8">
            <h4 className="text-lg font-bold text-stone-900 dark:text-stone-100 sm:text-xl">{QUEM_SOMOS.founder.name}</h4>
            <p className="mt-1 text-sm font-semibold" style={{ color: COLORS.primary }}>
              {QUEM_SOMOS.founder.role}
            </p>
            <p className="mt-4 text-sm leading-relaxed text-stone-600 dark:text-stone-400 sm:text-[0.9375rem] sm:leading-[1.65]">
