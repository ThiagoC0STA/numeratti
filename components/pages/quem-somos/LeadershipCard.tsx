...
export default function LeadershipCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-stone-200/90 dark:border-stone-800/90 bg-white dark:bg-neutral-950 shadow-[0_12px_40px_-24px_rgba(0,0,0,0.08)] ring-1 ring-stone-100/80 dark:ring-stone-800/60">
      <div
        className="pointer-events-none absolute -right-12 -top-12 h-44 w-44 rounded-full bg-[#ff6600]/[0.09] blur-2xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-stone-200/80 dark:via-stone-800/80 to-transparent"
        aria-hidden
      />
      ...
      <div className="relative p-6 sm:p-7">
        <div className="flex flex-wrap items-end justify-between gap-3 border-b border-stone-100 dark:border-stone-800 pb-4">
          <div>
            ...
            <h3 className="mt-1 text-lg font-bold tracking-tight text-stone-900 dark:text-stone-100 sm:text-xl">
