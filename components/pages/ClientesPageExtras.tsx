          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {ABOUT_STATS.map((stat, i) => (
              <ScrollReveal key={stat.label} delay={i * 0.06}>
                <div className="rounded-2xl border border-stone-200/80 dark:border-stone-800/80 bg-white dark:bg-neutral-950 p-8 text-center shadow-sm">
                  <AnimatedCounter
                    value={stat.value}
                    suffix={stat.suffix}
          ...
          <ScrollReveal>
            <div className="rounded-[1.75rem] border border-stone-200/80 dark:border-stone-800/80 bg-gradient-to-br from-stone-900 to-stone-800 px-8 py-12 text-center md:px-12">
              ...
              <a
                ...
                className="mt-8 inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-bold text-white transition-transform duration-200 ease-out hover:scale-[1.03] active:scale-[0.98] motion-reduce:transform-none"
