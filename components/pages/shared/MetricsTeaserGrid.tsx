...
export default function MetricsTeaserGrid() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#fff7f0] dark:from-neutral-950 via-white dark:via-neutral-950 to-stone-50 dark:to-neutral-950 py-20 lg:py-28">
      <div className="dark:hidden pointer-events-none absolute right-1/4 top-0 h-px w-1/2 bg-gradient-to-r from-transparent via-[#ff6600]/20 to-transparent" />
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <ScrollReveal>
          ...
          <h2 className="mt-4 text-center text-3xl font-bold tracking-tight text-stone-900 dark:text-stone-100 md:text-4xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-stone-600 dark:text-stone-400">
            Indicadores agregados do nosso trabalho com clientes, sempre com
            leitura no contexto do seu negócio.
          </p>
        </ScrollReveal>
          ...
          {METRICS.map((metric, i) => {
            ...
            return (
              <ScrollReveal key={metric.label} delay={i * 0.08}>
                <div className="h-full rounded-2xl border border-stone-200/80 dark:border-stone-800/80 bg-white dark:bg-neutral-950 p-8 shadow-[0_16px_50px_-28px_rgba(0,0,0,0.06)] transition-transform duration-300 ease-out hover:-translate-y-1.5 motion-reduce:transform-none motion-reduce:transition-none">
                  ...
                  <div className="mt-2 text-3xl font-bold tabular-nums text-stone-900 dark:text-stone-100 md:text-4xl">
                    <AnimatedCounter
                      value={metric.value}
                      suffix={metric.suffix}
                      format={
                        metric.label === "Impressões" ? "compact" : "full"
                      }
