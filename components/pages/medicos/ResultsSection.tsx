        ...
        <div className="max-w-3xl mb-12">
          ...
          <RevealOnScroll delay={0.2}>
            <p className="mt-6 text-white/55 text-lg max-w-2xl leading-relaxed">
              A Numeratti gerencia mídia paga em mais de 17 plataformas, de Fortaleza para o Brasil
              inteiro. Trazemos essa engenharia de campanhas para o consultório, com a camada de
              ética que a publicidade médica exige.
            </p>
          </RevealOnScroll>
        </div>
          ...
          {houseStats.map((s, i) => (
            <RevealOnScroll key={i} delay={i * 0.06}>
              <div className="bg-[#0f0a05] p-7 md:p-9 h-full">
                ...
                <div className="mono mt-4 text-white/50 text-[11px] uppercase tracking-[0.08em] leading-relaxed max-w-[220px]">
                  {s.label}
                </div>
              </div>
            </RevealOnScroll>
        ...
        <RevealOnScroll delay={0.1}>
          <div className="mt-8 grid lg:grid-cols-12 gap-8 items-center glass p-8 md:p-10">
            <div className="lg:col-span-4">
              <div className="mono text-orange-primary text-[10px] uppercase tracking-[0.24em] mb-3">
                case · saúde &amp; estética
              </div>
            ...
            <div className="lg:col-span-8 lg:border-l border-white/10 lg:pl-10">
              ...
              <p className="text-white/60 text-base leading-relaxed">
                Campanhas multicanal que unem visibilidade em massa com conversão de fundo de funil.
                É a mesma estrutura que aplicamos a consultórios e clínicas, medida em custo por
                consulta agendada.
              </p>
            </div>
          </div>
        ...
        <RevealOnScroll delay={0.1}>
          <div className="mt-10 flex flex-col items-center gap-6">
            <div className="flex flex-wrap justify-center gap-3">
              <span className="mono px-4 py-2 rounded-full border border-white/10 bg-white/[0.03] text-white/70 text-[11px] uppercase tracking-[0.14em]">
                Google Partner
              </span>
              <span className="mono px-4 py-2 rounded-full border border-white/10 bg-white/[0.03] text-white/70 text-[11px] uppercase tracking-[0.14em]">
                RD Station Partner
