...
export default function CasesContent() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-b from-white dark:from-neutral-950 via-[#fff8f3] dark:via-neutral-950 to-white dark:to-neutral-950 py-16 lg:py-22">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {ABOUT_STATS.map((stat, i) => (
              <ScrollReveal key={stat.label} delay={i * 0.05}>
                <div className="rounded-xl border border-stone-100 dark:border-stone-800 bg-stone-50/80 dark:bg-neutral-950/80 px-4 py-5 text-center">
                  <AnimatedCounter
                    value={stat.value}
                    suffix={stat.suffix}
