...
export default function QuemSomosContent() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-b from-white dark:from-neutral-950 via-stone-50/40 dark:via-neutral-950/40 to-white dark:to-neutral-950 py-20 lg:py-28">
        <div className="dark:hidden pointer-events-none absolute right-0 top-1/4 h-[420px] w-[420px] rounded-full bg-[#ff6600]/10 blur-[120px]" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            <ScrollReveal className="space-y-8">
              <span
                className="inline-flex items-center gap-2 rounded-full border border-[#ff6600]/20 bg-white/90 dark:bg-neutral-950/90 px-4 py-1.5 text-xs font-bold uppercase tracking-widest shadow-sm backdrop-blur-sm"
            ...
            <div className="space-y-8">
              ...
              <ScrollReveal delay={0.14}>
                <div className="relative overflow-hidden rounded-[1.75rem] border border-stone-200/80 dark:border-stone-800/80 bg-gradient-to-br from-white dark:from-neutral-950 to-stone-50/90 dark:to-neutral-950/90 p-8 shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="mt-5 inline-flex items-center gap-1 text-sm font-bold transition-transform duration-200 ease-out hover:translate-x-1 motion-reduce:transform-none"
                        style={{ color: COLORS.primary }}
                      >
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white dark:from-neutral-950 via-[#fff7f0] dark:via-neutral-950 to-white dark:to-neutral-950 py-20 lg:py-28">
        <div className="dark:hidden pointer-events-none absolute -left-32 top-1/3 h-[380px] w-[380px] rounded-full bg-[#ff6600]/8 blur-[120px]" />
      ...
      <section className="relative overflow-hidden bg-[#fafaf9] dark:bg-neutral-950 py-20 lg:py-28">
        <div className="dark:hidden pointer-events-none absolute left-0 top-0 h-[320px] w-[320px] rounded-full bg-[#ff6600]/6 blur-[100px]" />

        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <ScrollReveal>
            <h3 className="text-center text-3xl font-bold tracking-tight text-stone-900 dark:text-stone-100 md:text-4xl">
          ...
          <ScrollReveal delay={0.12}>
            <div className="mt-14 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-bold text-white shadow-lg shadow-orange-500/25 transition-transform duration-200 ease-out hover:scale-[1.03] active:scale-[0.98] motion-reduce:transform-none"
              ...
              <Link
                href="/clientes"
                className="inline-flex items-center gap-2 rounded-full border border-[#ff6600]/35 bg-white dark:bg-neutral-950 px-8 py-4 text-sm font-bold text-[#ff6600] shadow-md transition hover:bg-[#ff6600] hover:text-white"
              >
