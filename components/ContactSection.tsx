...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-gradient-to-br from-[#fff7f0] dark:from-neutral-950 via-white dark:via-neutral-950 to-[#f4f0ff] dark:to-neutral-950 py-28 lg:py-36"
    >
      <div className="dark:hidden pointer-events-none absolute -left-32 top-20 h-72 w-72 rounded-full bg-[#ff6600]/15 blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#ff6600]/20 bg-white/70 dark:bg-neutral-950/70 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#ff6600] shadow-sm backdrop-blur-sm">
              <Sparkles size={14} />
              Newsletter
            </div>
            <h2 className="mt-6 text-4xl font-bold tracking-tight text-stone-900 dark:text-stone-100 md:text-5xl">
              Assine nossa{" "}
                ...
                <div className="flex h-full flex-col justify-between p-8">
                  <div className="flex gap-2">
                    {[0, 1, 2].map((i) => (
                      <span
                        key={i}
                        className="h-2 w-8 rounded-full bg-gradient-to-r from-[#ff6600] to-[#f27405] animate-pulse"
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-4 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-bold text-white shadow-md transition-transform duration-300 hover:scale-[1.02] active:scale-[0.98]"
